...
Properties {
 ...
 _CutoffTex ("Texture cutoff", Range(0,1)) = 0
...
uniform highp float _CutoffTex;
varying highp vec2 xlv_TEXCOORD0;
varying lowp vec4 xlv_COLOR0;
void main ()
{
  ...
  x_5 = (((
   ...
   + 
    (1.0 - _Cutoff)
  ) * (tmpvar_4.w * _CutoffTex)) - 0.5);
  if ((x_5 < 0.0)) {
    discard;
  };
  highp vec4 Current_6;
  Current_6 = (_Color * tmpvar_4);
  highp vec3 tmpvar_7;
  ...
  ,   texture2d<half> _MainTex [[texture(0)]], sampler _mtlsmp__MainTex [[sampler(0)]])
{
  ...
  x_5 = (((
   ...
   + 
    (1.0 - _mtl_u._Cutoff)
  ) * ((float)tmpvar_4.w * _mtl_u._CutoffTex)) - 0.5);
  if ((x_5 < 0.0)) {
    discard_fragment();
  };
  float4 Current_6;
  Current_6 = float4((_mtl_u._Color * tmpvar_4));
  float3 tmpvar_7;
  ...
  ,   texture2d<half> _MainTex [[texture(0)]], sampler _mtlsmp__MainTex [[sampler(0)]])
{
  ...
  x_4 = (((
   ...
   + 
    (1.0 - _mtl_u._Cutoff)
  ) * ((float)tmpvar_3.w * _mtl_u._CutoffTex)) - 0.5);
  if ((x_4 < 0.0)) {
    discard_fragment();
  };
  ...
  ,   texture2d<half> _MainTex [[texture(0)]], sampler _mtlsmp__MainTex [[sampler(0)]])
{
  ...
  res_1.xyz = ((_mtl_i.xlv_TEXCOORD1 * (half)0.5) + (half)0.5);
  res_1.w = half(0.0);
...
void main ()
{
  ...
  x_7 = (((
   ...
   + 
    (1.0 - _Cutoff)
  ) * (tmpvar_6.w * _CutoffTex)) - 0.5);
  if ((x_7 < 0.0)) {
    discard;
  };
  highp vec4 Current_8;
  Current_8 = (_Color * tmpvar_6);
  highp vec3 tmpvar_9;
...
void main ()
{
  ...
  x_10 = (((
   ...
   + 
    (1.0 - _Cutoff)
  ) * (tmpvar_9.w * _CutoffTex)) - 0.5);
  if ((x_10 < 0.0)) {
    discard;
  };
  highp vec4 Current_11;
  Current_11 = (_Color * tmpvar_9);
  highp vec3 tmpvar_12;
...
void main ()
{
  ...
  x_6 = (((
   ...
   + 
    (1.0 - _Cutoff)
  ) * (tmpvar_5.w * _CutoffTex)) - 0.5);
  if ((x_6 < 0.0)) {
    discard;
  };
  highp vec4 Current_7;
  Current_7 = (_Color * tmpvar_5);
  highp vec3 tmpvar_8;
  ...
  ,   texture2d<half> _LightBuffer [[texture(1)]], sampler _mtlsmp__LightBuffer [[sampler(1)]])
{
  ...
  x_7 = (((
   ...
   + 
    (1.0 - _mtl_u._Cutoff)
  ) * ((float)tmpvar_6.w * _mtl_u._CutoffTex)) - 0.5);
  if ((x_7 < 0.0)) {
    discard_fragment();
  };
  float4 Current_8;
  Current_8 = float4((_mtl_u._Color * tmpvar_6));
  float3 tmpvar_9;
  tmpvar_9 = mix (Current_8, _mtl_u.transition_Color, float4(_mtl_u.transition_Mix)).xyz;
  tmpvar_5 = half3(tmpvar_9);
  half4 tmpvar_10;
  ...
  ,   texture2d<half> unity_LightmapInd [[texture(3)]], sampler _mtlsmp_unity_LightmapInd [[sampler(3)]])
{
  ...
  x_10 = (((
   ...
   + 
    (1.0 - _mtl_u._Cutoff)
  ) * ((float)tmpvar_9.w * _mtl_u._CutoffTex)) - 0.5);
  if ((x_10 < 0.0)) {
    discard_fragment();
  };
  float4 Current_11;
  Current_11 = float4((_mtl_u._Color * tmpvar_9));
  float3 tmpvar_12;
  ...
  ,   texture2d<half> _MainTex [[texture(0)]], sampler _mtlsmp__MainTex [[sampler(0)]])
{
  ...
  x_6 = (((
   ...
   + 
    (1.0 - _mtl_u._Cutoff)
  ) * ((float)tmpvar_5.w * _mtl_u._CutoffTex)) - 0.5);
  if ((x_6 < 0.0)) {
    discard_fragment();
  };
  float4 Current_7;
  Current_7 = float4((_mtl_u._Color * tmpvar_5));
  float3 tmpvar_8;
