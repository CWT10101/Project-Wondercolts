...
uniform highp float Blink;
uniform highp vec4 BlinkColor;
...
void main ()
{
  ...
  c_7 = tmpvar_8;
  highp vec3 tmpvar_9;
  tmpvar_9 = mix ((c_7.xyz * tmpvar_2.xyz), tmpvar_2.xyz, vec3(_Lerp));
  colo_6 = tmpvar_9;
  tmpvar_3 = colo_6;
  highp vec3 tmpvar_10;
  tmpvar_10 = (Blink * BlinkColor).xyz;
  tmpvar_4 = tmpvar_10;
  highp float tmpvar_11;
  tmpvar_11 = (1.0 - tmpvar_2.w);
  tmpvar_5 = tmpvar_11;
  lowp float x_12;
...
vertex xlatMtlShaderOutput xlatMtlMain (xlatMtlShaderInput _mtl_i [[stage_in]], constant xlatMtlShaderUniform& _mtl_u [[buffer(0)]])
{
  ...
  half3 tmpvar_4;
  float3x3 tmpvar_5;
  tmpvar_5[0] = _mtl_u._Object2World[0].xyz;
  tmpvar_5[1] = _mtl_u._Object2World[1].xyz;
  tmpvar_5[2] = _mtl_u._Object2World[2].xyz;
  float3 tmpvar_6;
  tmpvar_6 = (tmpvar_5 * (normalize(_mtl_i._glesNormal) * _mtl_u.unity_Scale.w));
  ...
  shlight_2 = float3(tmpvar_8);
  tmpvar_4 = half3(shlight_2);
...
void main ()
{
  ...
  tmpvar_13 = tmpvar_18;
  c_1.xyz = (tmpvar_3 * min ((2.0 * texture2D (unity_Lightmap, xlv_TEXCOORD1).xyz), vec3((tmpvar_13 * 2.0))));
  c_1.w = tmpvar_5;
  c_1.xyz = (c_1.xyz + tmpvar_4);
  c_1.w = tmpvar_5;
  gl_FragData[0] = c_1;
...
vertex xlatMtlShaderOutput xlatMtlMain (xlatMtlShaderInput _mtl_i [[stage_in]], constant xlatMtlShaderUniform& _mtl_u [[buffer(0)]])
{
  ...
  tmpvar_4 = half3(shlight_2);
  float3 tmpvar_23;
  tmpvar_23 = (_mtl_u._Object2World * _mtl_i._glesVertex).xyz;
  float4 tmpvar_24;
  tmpvar_24 = (_mtl_u.unity_4LightPosX0 - tmpvar_23.x);
  float4 tmpvar_25;
  tmpvar_25 = (_mtl_u.unity_4LightPosY0 - tmpvar_23.y);
  float4 tmpvar_26;
  tmpvar_26 = (_mtl_u.unity_4LightPosZ0 - tmpvar_23.z);
  float4 tmpvar_27;
   ...
   * 
    ...
    (tmpvar_27 * _mtl_u.unity_4LightAtten0)
  ))));
  float3 tmpvar_29;
  tmpvar_29 = ((float3)tmpvar_4 + ((
    ((_mtl_u.unity_LightColor[0].xyz * tmpvar_28.x) + (_mtl_u.unity_LightColor[1].xyz * tmpvar_28.y))
   + 
    (_mtl_u.unity_LightColor[2].xyz * tmpvar_28.z)
  ) + (_mtl_u.unity_LightColor[3].xyz * tmpvar_28.w)));
  tmpvar_4 = half3(tmpvar_29);
  _mtl_o.gl_Position = (_mtl_u.glstate_matrix_mvp * _mtl_i._glesVertex);
  _mtl_o.xlv_TEXCOORD0 = ((_mtl_i._glesMultiTexCoord0.xy * _mtl_u._MainTex_ST.xy) + _mtl_u._MainTex_ST.zw);
  _mtl_o.xlv_COLOR0 = tmpvar_1;
  _mtl_o.xlv_TEXCOORD1 = tmpvar_3;
...
void main ()
{
  ...
  tmpvar_14 = texture (_ShadowMapTexture, xlv_TEXCOORD3.xyz);
  ...
  c_17.w = tmpvar_5;
  c_1.w = c_17.w;
  c_1.xyz = (c_17.xyz + (tmpvar_3 * xlv_TEXCOORD2));
  c_1.xyz = (c_1.xyz + tmpvar_4);
  c_1.w = tmpvar_5;
  _glesFragData[0] = c_1;
}
...
void main ()
{
  ...
  tmpvar_15 = (_LightShadowData.x + (tmpvar_14 * (1.0 - _LightShadowData.x)));
  shadow_13 = tmpvar_15;
  c_1.xyz = (tmpvar_3 * min ((2.0 * texture2D (unity_Lightmap, xlv_TEXCOORD1).xyz), vec3((shadow_13 * 2.0))));
  c_1.w = tmpvar_5;
  c_1.xyz = (c_1.xyz + tmpvar_4);
  c_1.w = tmpvar_5;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  tmpvar_16 = (_LightShadowData.x + (tmpvar_15 * (1.0 - _LightShadowData.x)));
  shadow_13 = tmpvar_16;
  c_1.xyz = (tmpvar_3 * min ((2.0 * texture (unity_Lightmap, xlv_TEXCOORD1).xyz), vec3((shadow_13 * 2.0))));
  c_1.w = tmpvar_5;
  c_1.xyz = (c_1.xyz + tmpvar_4);
  c_1.w = tmpvar_5;
  _glesFragData[0] = c_1;
...
void main ()
{
  ...
  mediump vec3 lm_17;
  lowp vec3 tmpvar_18;
  tmpvar_18 = (2.0 * texture (unity_Lightmap, xlv_TEXCOORD1).xyz);
  lm_17 = tmpvar_18;
  lowp vec3 tmpvar_19;
...
vertex xlatMtlShaderOutput xlatMtlMain (xlatMtlShaderInput _mtl_i [[stage_in]], constant xlatMtlShaderUniform& _mtl_u [[buffer(0)]])
{
  ...
  tmpvar_4 = half3(shlight_2);
  float4 cse_23;
  cse_23 = (_mtl_u._Object2World * _mtl_i._glesVertex);
  float4 tmpvar_24;
  tmpvar_24 = (_mtl_u.unity_4LightPosX0 - cse_23.x);
  float4 tmpvar_25;
  tmpvar_25 = (_mtl_u.unity_4LightPosY0 - cse_23.y);
  float4 tmpvar_26;
  tmpvar_26 = (_mtl_u.unity_4LightPosZ0 - cse_23.z);
  float4 tmpvar_27;
  tmpvar_27 = (((tmpvar_24 * tmpvar_24) + (tmpvar_25 * tmpvar_25)) + (tmpvar_26 * tmpvar_26));
  float4 tmpvar_28;
  tmpvar_28 = (max (float4(0.0, 0.0, 0.0, 0.0), (
  ...
  _mtl_o.xlv_TEXCOORD1 = tmpvar_3;
  _mtl_o.xlv_TEXCOORD2 = tmpvar_4;
  _mtl_o.xlv_TEXCOORD3 = (_mtl_u.unity_World2Shadow[0] * cse_23);
  return _mtl_o;
}
...
ConstBuffer "$Globals" 50
VectorHalf 0 [_WorldSpaceLightPos0] 4
VectorHalf 8 [_LightColor0] 4
Float 16 [_Lerp]
Float 20 [Blink]
Vector 32 [BlinkColor]
ScalarHalf 48 [_Cutoff]
"metal_fs
#include <metal_stdlib>
using namespace metal;
struct xlatMtlShaderInput {
  ...
  ,   texture2d<half> _MainTex [[texture(0)]], sampler _mtlsmp__MainTex [[sampler(0)]])
{
  ...
  c_7 = tmpvar_8;
  float3 tmpvar_9;
  tmpvar_9 = mix (((float3)c_7.xyz * tmpvar_2.xyz), tmpvar_2.xyz, float3(_mtl_u._Lerp));
  colo_6 = half3(tmpvar_9);
  tmpvar_3 = colo_6;
  float3 tmpvar_10;
  tmpvar_10 = (_mtl_u.Blink * _mtl_u.BlinkColor).xyz;
  tmpvar_4 = half3(tmpvar_10);
  float tmpvar_11;
  tmpvar_11 = (1.0 - tmpvar_2.w);
  tmpvar_5 = half(tmpvar_11);
  half x_12;
  ...
  half4 c_13;
  c_13.xyz = ((tmpvar_3 * _mtl_u._LightColor0.xyz) * (max ((half)0.0, 
    dot (_mtl_i.xlv_TEXCOORD1, _mtl_u._WorldSpaceLightPos0.xyz)
  ) * (half)2.0));
  c_13.w = tmpvar_5;
  c_1.w = c_13.w;
  c_1.xyz = (c_13.xyz + (tmpvar_3 * _mtl_i.xlv_TEXCOORD2));
  c_1.xyz = (c_1.xyz + tmpvar_4);
  c_1.w = tmpvar_5;
  ...
  ,   texture2d<half> unity_Lightmap [[texture(1)]], sampler _mtlsmp_unity_Lightmap [[sampler(1)]])
{
  ...
  c_1.xyz = (tmpvar_3 * ((half)2.0 * unity_Lightmap.sample(_mtlsmp_unity_Lightmap, (float2)(_mtl_i.xlv_TEXCOORD1)).xyz));
  c_1.w = tmpvar_5;
  c_1.xyz = (c_1.xyz + tmpvar_4);
  c_1.w = tmpvar_5;
  _mtl_o._glesFragData_0 = c_1;
  ...
  ,   texture2d<half> unity_Lightmap [[texture(1)]], sampler _mtlsmp_unity_Lightmap [[sampler(1)]])
{
  ...
  half3 lm_13;
  half3 tmpvar_14;
  tmpvar_14 = ((half)2.0 * unity_Lightmap.sample(_mtlsmp_unity_Lightmap, (float2)(_mtl_i.xlv_TEXCOORD1)).xyz);
  lm_13 = tmpvar_14;
  half3 tmpvar_15;
  tmpvar_15 = (tmpvar_3 * lm_13);
  c_1.xyz = tmpvar_15;
  ...
  ,   texture2d<half> _MainTex [[texture(1)]], sampler _mtlsmp__MainTex [[sampler(1)]])
{
  ...
  half shadow_13;
  half tmpvar_14;
  tmpvar_14 = _ShadowMapTexture.sample_compare(_mtl_xl_shadow_sampler, (float2)(_mtl_i.xlv_TEXCOORD3.xyz).xy, (float)(_mtl_i.xlv_TEXCOORD3.xyz).z);
  half tmpvar_15;
  tmpvar_15 = tmpvar_14;
  float tmpvar_16;
  tmpvar_16 = (_mtl_u._LightShadowData.x + ((float)tmpvar_15 * (1.0 - _mtl_u._LightShadowData.x)));
  shadow_13 = half(tmpvar_16);
  half4 c_17;
  c_17.xyz = ((tmpvar_3 * _mtl_u._LightColor0.xyz) * ((
    max ((half)0.0, dot (_mtl_i.xlv_TEXCOORD1, _mtl_u._WorldSpaceLightPos0.xyz))
   * shadow_13) * (half)2.0));
  c_17.w = tmpvar_5;
  c_1.w = c_17.w;
  c_1.xyz = (c_17.xyz + (tmpvar_3 * _mtl_i.xlv_TEXCOORD2));
  c_1.xyz = (c_1.xyz + tmpvar_4);
  c_1.w = tmpvar_5;
  _mtl_o._glesFragData_0 = c_1;
  return _mtl_o;
  ...
  ,   texture2d<half> unity_Lightmap [[texture(2)]], sampler _mtlsmp_unity_Lightmap [[sampler(2)]])
{
  ...
  half shadow_13;
  half tmpvar_14;
  tmpvar_14 = _ShadowMapTexture.sample_compare(_mtl_xl_shadow_sampler, (float2)(_mtl_i.xlv_TEXCOORD2.xyz).xy, (float)(_mtl_i.xlv_TEXCOORD2.xyz).z);
  half tmpvar_15;
  tmpvar_15 = tmpvar_14;
  float tmpvar_16;
  tmpvar_16 = (_mtl_u._LightShadowData.x + ((float)tmpvar_15 * (1.0 - _mtl_u._LightShadowData.x)));
  shadow_13 = half(tmpvar_16);
  c_1.xyz = (tmpvar_3 * min (((half)2.0 * unity_Lightmap.sample(_mtlsmp_unity_Lightmap, (float2)(_mtl_i.xlv_TEXCOORD1)).xyz), half3((shadow_13 * (half)2.0))));
  c_1.w = tmpvar_5;
  c_1.xyz = (c_1.xyz + tmpvar_4);
  c_1.w = tmpvar_5;
  _mtl_o._glesFragData_0 = c_1;
  ...
  ,   texture2d<half> unity_Lightmap [[texture(2)]], sampler _mtlsmp_unity_Lightmap [[sampler(2)]])
{
  ...
  half3 lm_17;
  half3 tmpvar_18;
  tmpvar_18 = ((half)2.0 * unity_Lightmap.sample(_mtlsmp_unity_Lightmap, (float2)(_mtl_i.xlv_TEXCOORD1)).xyz);
  lm_17 = tmpvar_18;
  half3 tmpvar_19;
  tmpvar_19 = half3((shadow_13 * (half)2.0));
  half3 tmpvar_20;
  tmpvar_20 = (tmpvar_3 * min (lm_17, tmpvar_19));
  c_1.xyz = tmpvar_20;
  c_1.w = tmpvar_5;
...
void main ()
{
  ...
  c_7 = tmpvar_8;
  highp vec3 tmpvar_9;
  tmpvar_9 = mix ((c_7.xyz * tmpvar_3.xyz), tmpvar_3.xyz, vec3(_Lerp));
  colo_6 = tmpvar_9;
  tmpvar_4 = colo_6;
   ...
   * texture2D (_LightTexture0, vec2(tmpvar_13)).w) * 2.0));
  c_14.w = tmpvar_5;
  c_1.xyz = c_14.xyz;
  c_1.w = tmpvar_5;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  c_14.xyz = ((tmpvar_4 * _LightColor0.xyz) * ((
    max (0.0, dot (xlv_TEXCOORD1, lightDir_2))
   * texture (_LightTexture0, vec2(tmpvar_13)).w) * 2.0));
  c_14.w = tmpvar_5;
  c_1.xyz = c_14.xyz;
  c_1.w = tmpvar_5;
  _glesFragData[0] = c_1;
...
void main ()
{
  ...
  lowp vec4 c_12;
  c_12.xyz = ((tmpvar_4 * _LightColor0.xyz) * (max (0.0, 
...
void main ()
{
  ...
  atten_15 = ((float(
    (xlv_TEXCOORD3.z > 0.0)
  ) * texture2D (_LightTexture0, P_13).w) * texture2D (_LightTextureB0, vec2(tmpvar_14)).w);
  lowp vec4 c_16;
...
void main ()
{
  ...
  atten_15 = ((float(
    (xlv_TEXCOORD3.z > 0.0)
  ) * texture (_LightTexture0, P_13).w) * texture (_LightTextureB0, vec2(tmpvar_14)).w);
  lowp vec4 c_16;
  c_16.xyz = ((tmpvar_4 * _LightColor0.xyz) * ((
    max (0.0, dot (xlv_TEXCOORD1, lightDir_2))
   * atten_15) * 2.0));
...
vertex xlatMtlShaderOutput xlatMtlMain (xlatMtlShaderInput _mtl_i [[stage_in]], constant xlatMtlShaderUniform& _mtl_u [[buffer(0)]])
{
  ...
  _mtl_o.xlv_TEXCOORD1 = tmpvar_2;
  _mtl_o.xlv_TEXCOORD2 = tmpvar_3;
  _mtl_o.xlv_TEXCOORD3 = (_mtl_u._LightMatrix0 * cse_7);
  return _mtl_o;
}
...
void main ()
{
  ...
  c_14.xyz = ((tmpvar_4 * _LightColor0.xyz) * ((
    max (0.0, dot (xlv_TEXCOORD1, lightDir_2))
   * 
    (texture2D (_LightTextureB0, vec2(tmpvar_13)).w * textureCube (_LightTexture0, xlv_TEXCOORD3).w)
  ) * 2.0));
  c_14.w = tmpvar_5;
  c_1.xyz = c_14.xyz;
  c_1.w = tmpvar_5;
...
void main ()
{
  ...
  c_14.xyz = ((tmpvar_4 * _LightColor0.xyz) * ((
    max (0.0, dot (xlv_TEXCOORD1, lightDir_2))
   * 
    (texture (_LightTextureB0, vec2(tmpvar_13)).w * texture (_LightTexture0, xlv_TEXCOORD3).w)
  ) * 2.0));
  c_14.w = tmpvar_5;
  c_1.xyz = c_14.xyz;
  c_1.w = tmpvar_5;
...
SetTexture 1 [_MainTex] 2D 1
ConstBuffer "$Globals" 14
VectorHalf 0 [_LightColor0] 4
Float 8 [_Lerp]
ScalarHalf 12 [_Cutoff]
"metal_fs
#include <metal_stdlib>
using namespace metal;
struct xlatMtlShaderInput {
  ...
  ,   texture2d<half> _MainTex [[texture(1)]], sampler _mtlsmp__MainTex [[sampler(1)]])
{
  ...
  c_7 = tmpvar_8;
  float3 tmpvar_9;
  tmpvar_9 = mix (((float3)c_7.xyz * tmpvar_3.xyz), tmpvar_3.xyz, float3(_mtl_u._Lerp));
  colo_6 = half3(tmpvar_9);
  tmpvar_4 = colo_6;
  float tmpvar_10;
  tmpvar_10 = (1.0 - tmpvar_3.w);
  tmpvar_5 = half(tmpvar_10);
  half x_11;
  ...
  half3 tmpvar_12;
  tmpvar_12 = normalize(_mtl_i.xlv_TEXCOORD2);
  lightDir_2 = tmpvar_12;
  float tmpvar_13;
  tmpvar_13 = dot (_mtl_i.xlv_TEXCOORD3, _mtl_i.xlv_TEXCOORD3);
  half4 c_14;
  c_14.xyz = ((tmpvar_4 * _mtl_u._LightColor0.xyz) * ((
    max ((half)0.0, dot (_mtl_i.xlv_TEXCOORD1, lightDir_2))
   * _LightTexture0.sample(_mtlsmp__LightTexture0, (float2)(float2(tmpvar_13))).w) * (half)2.0));
  c_14.w = tmpvar_5;
  c_1.xyz = c_14.xyz;
  c_1.w = tmpvar_5;
  _mtl_o._glesFragData_0 = c_1;
  ...
  ,   texture2d<half> _MainTex [[texture(0)]], sampler _mtlsmp__MainTex [[sampler(0)]])
{
  ...
  lightDir_2 = _mtl_i.xlv_TEXCOORD2;
  half4 c_12;
  c_12.xyz = ((tmpvar_4 * _mtl_u._LightColor0.xyz) * (max ((half)0.0, 
    dot (_mtl_i.xlv_TEXCOORD1, lightDir_2)
  ) * (half)2.0));
  c_12.w = tmpvar_5;
  c_1.xyz = c_12.xyz;
  c_1.w = tmpvar_5;
  ...
  ,   texture2d<half> _MainTex [[texture(2)]], sampler _mtlsmp__MainTex [[sampler(2)]])
{
  ...
  lightDir_2 = tmpvar_12;
  float2 P_13;
  P_13 = ((_mtl_i.xlv_TEXCOORD3.xy / _mtl_i.xlv_TEXCOORD3.w) + 0.5);
  float tmpvar_14;
  tmpvar_14 = dot (_mtl_i.xlv_TEXCOORD3.xyz, _mtl_i.xlv_TEXCOORD3.xyz);
  half atten_15;
  atten_15 = half(((float(
    (_mtl_i.xlv_TEXCOORD3.z > 0.0)
  ) * (float)_LightTexture0.sample(_mtlsmp__LightTexture0, (float2)(P_13)).w) * (float)_LightTextureB0.sample(_mtlsmp__LightTextureB0, (float2)(float2(tmpvar_14))).w));
  half4 c_16;
  c_16.xyz = ((tmpvar_4 * _mtl_u._LightColor0.xyz) * ((
    max ((half)0.0, dot (_mtl_i.xlv_TEXCOORD1, lightDir_2))
   * atten_15) * (half)2.0));
  c_16.w = tmpvar_5;
  c_1.xyz = c_16.xyz;
  ...
  ,   texture2d<half> _MainTex [[texture(2)]], sampler _mtlsmp__MainTex [[sampler(2)]])
{
  ...
  c_14.xyz = ((tmpvar_4 * _mtl_u._LightColor0.xyz) * ((
    max ((half)0.0, dot (_mtl_i.xlv_TEXCOORD1, lightDir_2))
   * 
    (_LightTextureB0.sample(_mtlsmp__LightTextureB0, (float2)(float2(tmpvar_13))).w * _LightTexture0.sample(_mtlsmp__LightTexture0, (float3)(_mtl_i.xlv_TEXCOORD3)).w)
  ) * (half)2.0));
  c_14.w = tmpvar_5;
  c_1.xyz = c_14.xyz;
  c_1.w = tmpvar_5;
  ...
  ,   texture2d<half> _MainTex [[texture(1)]], sampler _mtlsmp__MainTex [[sampler(1)]])
{
  ...
  lightDir_2 = _mtl_i.xlv_TEXCOORD2;
  half4 c_12;
  c_12.xyz = ((tmpvar_4 * _mtl_u._LightColor0.xyz) * ((
    max ((half)0.0, dot (_mtl_i.xlv_TEXCOORD1, lightDir_2))
   * _LightTexture0.sample(_mtlsmp__LightTexture0, (float2)(_mtl_i.xlv_TEXCOORD3)).w) * (half)2.0));
  c_12.w = tmpvar_5;
  c_1.xyz = c_12.xyz;
  c_1.w = tmpvar_5;
  _mtl_o._glesFragData_0 = c_1;
...
fragment xlatMtlShaderOutput xlatMtlMain (xlatMtlShaderInput _mtl_i [[stage_in]], constant xlatMtlShaderUniform& _mtl_u [[buffer(0)]])
{
  ...
  float tmpvar_4;
  tmpvar_4 = (1.0 - tmpvar_2.w);
  tmpvar_3 = half(tmpvar_4);
  half x_5;
  x_5 = (tmpvar_3 - _mtl_u._Cutoff);
  if ((x_5 < (half)0.0)) {
    discard_fragment();
  };
...
void main ()
{
  ...
  tmpvar_11 = mix ((c_9.xyz * tmpvar_4.xyz), tmpvar_4.xyz, vec3(_Lerp));
  colo_8 = tmpvar_11;
  tmpvar_5 = colo_8;
  highp vec3 tmpvar_12;
  tmpvar_12 = (Blink * BlinkColor).xyz;
  tmpvar_6 = tmpvar_12;
  highp float tmpvar_13;
  tmpvar_13 = (1.0 - tmpvar_4.w);
  tmpvar_7 = tmpvar_13;
  lowp float x_14;
  ...
  lowp vec4 c_18;
  mediump vec3 tmpvar_19;
  tmpvar_19 = (tmpvar_5 * light_3.xyz);
  c_18.xyz = tmpvar_19;
  c_18.w = tmpvar_7;
  c_2 = c_18;
...
vertex xlatMtlShaderOutput xlatMtlMain (xlatMtlShaderInput _mtl_i [[stage_in]], constant xlatMtlShaderUniform& _mtl_u [[buffer(0)]])
{
  ...
  o_4.zw = tmpvar_3.zw;
  float3x3 tmpvar_7;
  tmpvar_7[0] = _mtl_u._Object2World[0].xyz;
  tmpvar_7[1] = _mtl_u._Object2World[1].xyz;
  tmpvar_7[2] = _mtl_u._Object2World[2].xyz;
  float4 tmpvar_8;
  tmpvar_8.w = 1.0;
  tmpvar_8.xyz = (tmpvar_7 * (normalize(_mtl_i._glesNormal) * _mtl_u.unity_Scale.w));
  half3 tmpvar_9;
  half4 normal_10;
...
void main ()
{
  ...
  mediump vec3 colo_11;
  mediump vec4 c_12;
  lowp vec4 tmpvar_13;
  tmpvar_13 = texture2D (_MainTex, xlv_TEXCOORD0);
  c_12 = tmpvar_13;
  highp vec3 tmpvar_14;
  tmpvar_14 = mix ((c_12.xyz * tmpvar_7.xyz), tmpvar_7.xyz, vec3(_Lerp));
  colo_11 = tmpvar_14;
  tmpvar_8 = colo_11;
  highp vec3 tmpvar_15;
  tmpvar_15 = (Blink * BlinkColor).xyz;
  tmpvar_9 = tmpvar_15;
  highp float tmpvar_16;
  tmpvar_16 = (1.0 - tmpvar_7.w);
  tmpvar_10 = tmpvar_16;
  lowp float x_17;
  ...
  tmpvar_24 = (tmpvar_8 * light_6.xyz);
  c_23.xyz = tmpvar_24;
  c_23.w = tmpvar_10;
  c_2 = c_23;
...
vertex xlatMtlShaderOutput xlatMtlMain (xlatMtlShaderInput _mtl_i [[stage_in]], constant xlatMtlShaderUniform& _mtl_u [[buffer(0)]])
{
  ...
  o_4.xy = (tmpvar_6 + tmpvar_5.w);
  o_4.zw = tmpvar_3.zw;
  tmpvar_2.xyz = (((_mtl_u._Object2World * _mtl_i._glesVertex).xyz - _mtl_u.unity_ShadowFadeCenterAndType.xyz) * _mtl_u.unity_ShadowFadeCenterAndType.w);
  tmpvar_2.w = (-((_mtl_u.glstate_matrix_modelview0 * _mtl_i._glesVertex).z) * (1.0 - _mtl_u.unity_ShadowFadeCenterAndType.w));
  _mtl_o.gl_Position = tmpvar_3;
  _mtl_o.xlv_TEXCOORD0 = ((_mtl_i._glesMultiTexCoord0.xy * _mtl_u._MainTex_ST.xy) + _mtl_u._MainTex_ST.zw);
  _mtl_o.xlv_COLOR0 = tmpvar_1;
  _mtl_o.xlv_TEXCOORD1 = o_4;
...
void main ()
{
  ...
  tmpvar_21 = (tmpvar_5 * tmpvar_19.xyz);
  c_20.xyz = tmpvar_21;
  c_20.w = tmpvar_7;
  c_2 = c_20;
  c_2.xyz = (c_2.xyz + tmpvar_6);
  ...
  ,   texture2d<half> _LightBuffer [[texture(1)]], sampler _mtlsmp__LightBuffer [[sampler(1)]])
{
  ...
  c_9 = tmpvar_10;
  float3 tmpvar_11;
  tmpvar_11 = mix (((float3)c_9.xyz * tmpvar_4.xyz), tmpvar_4.xyz, float3(_mtl_u._Lerp));
  colo_8 = half3(tmpvar_11);
  tmpvar_5 = colo_8;
  float3 tmpvar_12;
  tmpvar_12 = (_mtl_u.Blink * _mtl_u.BlinkColor).xyz;
  tmpvar_6 = half3(tmpvar_12);
  float tmpvar_13;
  tmpvar_13 = (1.0 - tmpvar_4.w);
  tmpvar_7 = half(tmpvar_13);
  half x_14;
  ...
  half4 tmpvar_15;
  tmpvar_15 = _LightBuffer.sample(_mtlsmp__LightBuffer, ((float2)(_mtl_i.xlv_TEXCOORD1).xy / (float)(_mtl_i.xlv_TEXCOORD1).w));
  light_3 = tmpvar_15;
  half4 tmpvar_16;
  tmpvar_16 = -(log2(max (light_3, (half4)float4(0.001, 0.001, 0.001, 0.001))));
  light_3.w = tmpvar_16.w;
  float3 tmpvar_17;
  tmpvar_17 = ((float3)tmpvar_16.xyz + _mtl_i.xlv_TEXCOORD2);
  light_3.xyz = half3(tmpvar_17);
  half4 c_18;
  half3 tmpvar_19;
  tmpvar_19 = (tmpvar_5 * light_3.xyz);
  c_18.xyz = tmpvar_19;
  ...
  ,   texture2d<half> unity_LightmapInd [[texture(3)]], sampler _mtlsmp_unity_LightmapInd [[sampler(3)]])
{
  ...
  c_12 = tmpvar_13;
  float3 tmpvar_14;
  tmpvar_14 = mix (((float3)c_12.xyz * tmpvar_7.xyz), tmpvar_7.xyz, float3(_mtl_u._Lerp));
  colo_11 = half3(tmpvar_14);
  tmpvar_8 = colo_11;
  float3 tmpvar_15;
  tmpvar_15 = (_mtl_u.Blink * _mtl_u.BlinkColor).xyz;
  tmpvar_9 = half3(tmpvar_15);
  float tmpvar_16;
  tmpvar_16 = (1.0 - tmpvar_7.w);
  tmpvar_10 = half(tmpvar_16);
  half x_17;
  ...
  half4 tmpvar_18;
  tmpvar_18 = _LightBuffer.sample(_mtlsmp__LightBuffer, ((float2)(_mtl_i.xlv_TEXCOORD1).xy / (float)(_mtl_i.xlv_TEXCOORD1).w));
  light_6 = tmpvar_18;
  half4 tmpvar_19;
  tmpvar_19 = -(log2(max (light_6, (half4)float4(0.001, 0.001, 0.001, 0.001))));
  light_6.w = tmpvar_19.w;
  float tmpvar_20;
  tmpvar_20 = ((sqrt(
    dot (_mtl_i.xlv_TEXCOORD3, _mtl_i.xlv_TEXCOORD3)
  ) * _mtl_u.unity_LightmapFade.z) + _mtl_u.unity_LightmapFade.w);
  lmFade_5 = half(tmpvar_20);
  half3 tmpvar_21;
  tmpvar_21 = ((half)2.0 * unity_Lightmap.sample(_mtlsmp_unity_Lightmap, (float2)(_mtl_i.xlv_TEXCOORD2)).xyz);
  lmFull_4 = tmpvar_21;
  half3 tmpvar_22;
  tmpvar_22 = ((half)2.0 * unity_LightmapInd.sample(_mtlsmp_unity_LightmapInd, (float2)(_mtl_i.xlv_TEXCOORD2)).xyz);
  lmIndirect_3 = tmpvar_22;
  light_6.xyz = (tmpvar_19.xyz + mix (lmIndirect_3, lmFull_4, half3(clamp (lmFade_5, (half)0.0, (half)1.0))));
  half4 c_23;
  half3 tmpvar_24;
  tmpvar_24 = (tmpvar_8 * light_6.xyz);
  c_23.xyz = tmpvar_24;
  ...
  ,   texture2d<half> unity_Lightmap [[texture(2)]], sampler _mtlsmp_unity_Lightmap [[sampler(2)]])
{
  ...
  half3 lm_16;
  half3 tmpvar_17;
  tmpvar_17 = ((half)2.0 * unity_Lightmap.sample(_mtlsmp_unity_Lightmap, (float2)(_mtl_i.xlv_TEXCOORD2)).xyz);
  lm_16 = tmpvar_17;
  half4 tmpvar_18;
  ...
  ,   texture2d<half> _LightBuffer [[texture(1)]], sampler _mtlsmp__LightBuffer [[sampler(1)]])
{
  ...
  light_3 = tmpvar_15;
  half4 tmpvar_16;
  tmpvar_16 = max (light_3, (half4)float4(0.001, 0.001, 0.001, 0.001));
  light_3.w = tmpvar_16.w;
  float3 tmpvar_17;
  tmpvar_17 = ((float3)tmpvar_16.xyz + _mtl_i.xlv_TEXCOORD2);
  light_3.xyz = half3(tmpvar_17);
  ...
  ,   texture2d<half> unity_LightmapInd [[texture(3)]], sampler _mtlsmp_unity_LightmapInd [[sampler(3)]])
{
  ...
  light_6 = tmpvar_18;
  half4 tmpvar_19;
  tmpvar_19 = max (light_6, (half4)float4(0.001, 0.001, 0.001, 0.001));
  light_6.w = tmpvar_19.w;
  float tmpvar_20;
  tmpvar_20 = ((sqrt(
    dot (_mtl_i.xlv_TEXCOORD3, _mtl_i.xlv_TEXCOORD3)
  ...
  ,   texture2d<half> unity_Lightmap [[texture(2)]], sampler _mtlsmp_unity_Lightmap [[sampler(2)]])
{
  ...
  tmpvar_18.xyz = lm_16;
  half4 tmpvar_19;
  tmpvar_19 = (max (light_3, (half4)float4(0.001, 0.001, 0.001, 0.001)) + tmpvar_18);
  light_3 = tmpvar_19;
  half4 c_20;
  half3 tmpvar_21;
  tmpvar_21 = (tmpvar_5 * tmpvar_19.xyz);
