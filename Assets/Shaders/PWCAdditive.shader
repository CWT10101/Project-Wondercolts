...
void main ()
{
  ...
  colo_2 = tmpvar_3;
  colo_2.w = (colo_2.w * (1.0 - transition_Mix));
  tmpvar_1 = colo_2;
...
void main ()
{
  ...
  highp vec4 colo_2;
  lowp vec4 tmpvar_3;
  tmpvar_3 = ((xlv_COLOR * _TintColor) * texture (_MainTex, xlv_TEXCOORD0));
  colo_2 = tmpvar_3;
  colo_2.w = (colo_2.w * (1.0 - transition_Mix));
  tmpvar_1 = colo_2;
...
void main ()
{
  ...
  tmpvar_2.w = tmpvar_6;
  lowp vec4 tmpvar_7;
  tmpvar_7 = ((tmpvar_2 * _TintColor) * texture2D (_MainTex, xlv_TEXCOORD0));
  colo_3 = tmpvar_7;
  colo_3.w = (colo_3.w * (1.0 - transition_Mix));
  tmpvar_1 = colo_3;
  gl_FragData[0] = tmpvar_1;
}
...
void main ()
{
  ...
  tmpvar_2.w = tmpvar_6;
  lowp vec4 tmpvar_7;
  tmpvar_7 = ((tmpvar_2 * _TintColor) * texture (_MainTex, xlv_TEXCOORD0));
  colo_3 = tmpvar_7;
  colo_3.w = (colo_3.w * (1.0 - transition_Mix));
  tmpvar_1 = colo_3;
  _glesFragData[0] = tmpvar_1;
  ...
  ,   texture2d<half> _MainTex [[texture(0)]], sampler _mtlsmp__MainTex [[sampler(0)]])
{
  ...
  float4 colo_2;
  half4 tmpvar_3;
  tmpvar_3 = ((_mtl_i.xlv_COLOR * _mtl_u._TintColor) * _MainTex.sample(_mtlsmp__MainTex, (float2)(_mtl_i.xlv_TEXCOORD0)));
  colo_2 = float4(tmpvar_3);
  colo_2.w = (colo_2.w * (1.0 - _mtl_u.transition_Mix));
  tmpvar_1 = half4(colo_2);
  ...
  ,   texture2d<half> _CameraDepthTexture [[texture(1)]], sampler _mtlsmp__CameraDepthTexture [[sampler(1)]])
{
  ...
  half4 tmpvar_7;
  tmpvar_7 = ((tmpvar_2 * _mtl_u._TintColor) * _MainTex.sample(_mtlsmp__MainTex, (float2)(_mtl_i.xlv_TEXCOORD0)));
  colo_3 = float4(tmpvar_7);
  colo_3.w = (colo_3.w * (1.0 - _mtl_u.transition_Mix));
  tmpvar_1 = half4(colo_3);
  _mtl_o._glesFragData_0 = tmpvar_1;
  return _mtl_o;
}
